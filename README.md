...
NewPrint          18.9µs ± 2%    18.7µs ± 4%     ~     (p=0.123 n=10+10)
NewPrint-4        6.26µs ± 2%    5.69µs ± 7%   -9.11%  (p=0.000 n=8+10)
NewPrint-12       4.09µs ± 3%    3.70µs ± 4%   -9.52%  (p=0.000 n=10+10)
ColorPrint        2.66µs ± 5%    2.18µs ± 2%  -17.97%  (p=0.000 n=10+9)
ColorPrint-4       871ns ± 8%     687ns ±10%  -21.16%  (p=0.000 n=10+10)
ColorPrint-12      639ns ± 2%     512ns ± 4%  -19.94%  (p=0.000 n=10+10)
ColorString       3.60µs ± 4%    2.93µs ± 3%  -18.75%  (p=0.000 n=10+9)
ColorString-4     1.37µs ±11%    1.14µs ± 5%  -17.14%  (p=0.000 n=10+9)
ColorString-12    1.56µs ±19%    1.18µs ± 5%  -24.27%  (p=0.000 n=10+10)
...
ColorString       4.72kB ± 0%    4.69kB ± 0%   -0.64%  (p=0.001 n=8+9)
ColorString-4     4.74kB ± 0%    4.71kB ± 0%   -0.59%  (p=0.000 n=9+9)
ColorString-12    4.76kB ± 0%    4.74kB ± 0%   -0.53%  (p=0.000 n=10+10)
